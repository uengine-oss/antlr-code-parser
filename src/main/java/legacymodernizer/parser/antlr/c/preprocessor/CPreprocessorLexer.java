// Generated from antlr-grammars/CPreprocessorLexer.g4 by ANTLR 4.13.2
...
public class CPreprocessorLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"HASHHASH", "HASH", "DEFINE", "ELLIPSIS", "LPAREN", "RPAREN", "COMMA",
			...
			"BLOCK_COMMENT_NEWLINE", "BLOCK_COMMENT_CONTENT", "BLOCK_COMMENT_STAR",
			"ENCODING_PREFIX", "S_CHAR", "C_CHAR", "ESCAPE_SEQUENCE", "IDENTIFIER_NONDIGIT",
			"IDENTIFIER_CONTINUE", "UNIVERSAL_CHARACTER_NAME", "HEX_QUAD", "HEX_DIGIT",
			"DIGIT"
		};
	}
